...
def delete_review_and_update_marker(review_id):
    ...
    if remaining_reviews:
        ...
        # Delete marker and its associated data
...
def delete_marker_and_contents(marker_id):
    Review.query.filter_by(marker_id=marker_id).delete()  # Delete all reviews
    Event.query.filter_by(marker_id=marker_id).delete()  # Delete all events
    UserMarker.query.filter_by(marker_id=marker_id).delete()  # Delete all UserMarker links
